...
import DynaStaPageServis from "./DynaStaPageServis";

export default function OnePageWholeServis({route,noTitle}){
    ...
    return(
        ...
        <section className={`pageContainer`}>
            <DynaStaPageServis data={data} route={route} noTitle={noTitle}/>
        </section>
